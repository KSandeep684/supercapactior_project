# ==============================================================================
# FINAL CAPSTONE PROJECT: V31 - DEFINITIVE AI MODEL NAME FIX
# ==============================================================================
...
try:
    ...
    # ### CORRECTION: Use the most stable model name available ###
    ...
    if not ai_enabled:
        ...
        if st.button("Generate AI Analysis"):
            with st.spinner("The AI is analyzing the results..."):
                ...
                if prompt:
                    try:
                        # For gemini-pro-vision, we must send the prompt as a list
